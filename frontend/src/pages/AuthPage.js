      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-end p-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-2xl font-bold text-white" style={{ fontFamily: 'IBM Plex Sans' }}>UrbanLogix</span>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-[#F3F4F6]">
        <div className="w-full max-w-[400px]">
          <div className="lg:hidden flex items-center gap-2 mb-8">
            ...
            <span className="text-xl font-bold" style={{ fontFamily: 'IBM Plex Sans' }}>UrbanLogix</span>
          </div>
